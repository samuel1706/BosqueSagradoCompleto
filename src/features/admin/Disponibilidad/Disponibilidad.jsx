...
// ===============================================
const API_DISPONIBILIDAD = "http://localhost:5204/api/Disponibilidad";
...
const Disponibilidad = () => {
  ...
  const handleApiError = (error, operation) => {
    ...
    if (error.code === 'NETWORK_ERROR' || error.message === 'Network Error') {
      ...
      errorMessage = "No se puede conectar al servidor. Asegúrate de que la API esté corriendo en http://localhost:5204";
